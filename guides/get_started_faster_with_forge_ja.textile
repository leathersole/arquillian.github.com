...
すでに "general getting started guide":../getting_started で見ているかもしれませんが、Arquillianのセットアップは簡単です。たくさんのコピー／ペースト作業ですが、pom.xmlにArquillianのための新しいコンテナを設定します。
